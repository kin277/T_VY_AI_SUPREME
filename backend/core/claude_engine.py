"""
====================================================================
AI ENGINE - TÍCH HỢP GROQ API (MODEL LLAMA 3.3 70B MIỄN PHÍ)
====================================================================
"""
...
class ClaudeEngine:
    ...
    def process(self, query: str, context: str = "", complexity: str = "Trung bình") -> Dict[str, Any]:
        # Đọc API Key từ Environment Variable trên Render hoặc file .env
        api_key = (
        ...
        if not api_key:
            return {"error": "Thiếu GROQ_API_KEY. Vui lòng thêm Key vào phần Environment Variables trên Render."}
